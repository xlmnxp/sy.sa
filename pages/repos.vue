<template>
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 p-8">
      <div class="container mx-auto">
        <h1 class="text-3xl font-bold text-primary dark:text-primary-dark mb-8 animate-fadeIn">My GitHub Repositories</h1>
        ...
        <div v-else-if="error" class="bg-red-100 dark:bg-red-900 border border-red-400 dark:border-red-600 text-red-700 dark:text-red-300 px-4 py-3 rounded animate-fadeIn">
        ...
        >
          <RepoCard
            ...
            class="animate-slideInFromBottom"
          />
        </TransitionGroup>
      </div>
    </div>
  ...
  .animate-slideInFromBottom {
    animation: slideInFromBottom 0.1s ease-out forwards;
  }
