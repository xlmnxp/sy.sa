    ...
    <div
        ...
        <div class="flex justify-between items-start mb-4">
            ...
            <div class="flex items-center">
                <span v-if="repo.stargazers_count" class="flex items-center text-gray-600 dark:text-gray-400 ms-2">
                ...
                <span v-if="repo.forks_count" class="flex items-center text-gray-600 dark:text-gray-400 ms-2">
                    <svg class="w-4 h-4 me-1" fill="currentColor" viewBox="0 0 16 16">
                        <path
